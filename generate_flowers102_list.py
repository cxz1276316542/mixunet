...
"""
Usage: 
    python ./generate_flower102_list.py prefix_folder mode
    python generate_flower102_list.py jpg train > train_list.txt
    python ./generate_flower102_list.py jpg valid > val_list.txt
"""
