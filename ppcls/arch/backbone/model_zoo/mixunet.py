...
class MixFormer(nn.Layer):
    ...
    def forward(self, x):
        ...
        for i_layer in range(self.num_layers-2):
            #print(x_item.shape)
            x = paddle.concat((x, x_list[i_layer]), axis=1)
...
def MixUNet_B0(pretrained=False, use_ssld=False, **kwargs):
    model = MixFormer(
        embed_dim=24,
        depths=[1, 2, 6, 6],
        num_heads=[3, 6, 12, 24],
...
def MixUNet_B1(pretrained=False, use_ssld=False, **kwargs):
    model = MixFormer(
        embed_dim=32,
        depths=[1, 2, 6, 6],
        num_heads=[3, 6, 12, 24],
...
def MixUNet_B2(pretrained=False, use_ssld=False, **kwargs):
    model = MixFormer(
        embed_dim=32,
        depths=[2, 2, 8, 8],
        num_heads=[2, 4, 8, 16],
...
def MixUNet_B3(pretrained=False, use_ssld=False, **kwargs):
    model = MixFormer(
        embed_dim=48,
        depths=[1, 2, 6, 6],
        num_heads=[3, 6, 12, 24],
...
def MixUNet_B4(pretrained=False, use_ssld=False, **kwargs):
    model = MixFormer(
        embed_dim=64,
        depths=[2, 2, 8, 8],
        num_heads=[4, 8, 16, 32],
...
def MixUNet_B5(pretrained=False, use_ssld=False, **kwargs):
    model = MixFormer(
        embed_dim=96,
        depths=[1, 2, 8, 6],
...
def MixUNet_B6(pretrained=False, use_ssld=False, **kwargs):
    model = MixFormer(
        embed_dim=96,
        depths=[2, 4, 16, 12],
        num_heads=[6, 12, 24, 48],
